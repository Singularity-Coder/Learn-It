...
//            startActivity(activityIntent)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /** Temp commented as its adding unnecessary padding when android:fitsSystemWindows="true" which
         * is necessary for bottom add item bar to show on top of keyboard */
